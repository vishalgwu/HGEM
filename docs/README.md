...
| [Architecture decisions](adr/) | Rationale for dual stores, bitemporal history, async evaluation, entropy, MCP, the Day-2 amendments to `ExtractionResult` and `Provenance`, and **entity resolution — which binds and never matches** |
