...
| [Architecture decisions](adr/) | Rationale for dual stores, bitemporal history, async evaluation, entropy, MCP, and the Day-2 amendments to `ExtractionResult` and `Provenance` |
